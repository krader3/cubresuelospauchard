...
export default function About() {
  ...
  return (
    <section
      id="nosotros"
      className="scroll-mt-16 bg-[#1c1917] text-white py-24 lg:py-32 overflow-hidden"
    >
      <div className="max-w-7xl mx-auto px-6 lg:px-10">
        ...
        >
          <div className={`reveal ${textInView ? 'visible' : ''}`}>
            <span className="text-[#5a9168] text-sm font-semibold tracking-widest uppercase mb-4 block">
              Nuestra historia
            </span>
            <h2 className="text-4xl lg:text-5xl font-bold tracking-tight leading-[1.1] mb-6">
              Una pasión familiar<br />
              <span className="text-[#7db88a]">convertida en oficio</span>
            </h2>
            <p className="text-[#a89f97] text-lg leading-relaxed mb-5 max-w-[55ch]">
            ...
            <p className="text-[#a89f97] leading-relaxed max-w-[55ch]">
          ...
          <div className={`reveal reveal-delay-1 ${textInView ? 'visible' : ''}`}>
            <div className="relative">
              ...
              {/* Floating badge */}
              <div className="absolute -bottom-4 -left-4 bg-[#3d6b47] text-white px-5 py-4 rounded-2xl shadow-2xl">
        ...
        <div
          ref={statsRef}
          className="grid grid-cols-1 md:grid-cols-3 divide-y md:divide-y-0 md:divide-x divide-[#2a2520]"
        >
          {stats.map((s, i) => (
            <div
              key={s.label}
            ...
            >
              ...
              <div className="text-sm text-[#a89f97] leading-relaxed">{s.desc}</div>
            </div>
          ))}
        </div>
